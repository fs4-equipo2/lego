...
const Navbar = () => {
  ...
  const [isOpenSidebar, openModalSidebar, closeModalSidebar] =
    useModalSidebar(false);
      ...
      <div className={styles.containerPadreNav}>
        <div className={styles.containerNav}>
          <div className={styles.containerLeft}>
            ...
            <ModalSidebar isOpen={isOpenSidebar} closeModal={closeModalSidebar}>
              <LinksNavbarResponsive
                handleCloseModal={closeModalSidebar}
                handleOpenLogin={openModalLogIn}
              />
            </ModalSidebar>
            <Link to="/">
              <Logo />
          ...
          <div className={styles.containerRight}>
            ...
            <div className={styles.iconoCara} onClick={openModalLogIn}>
              <svg
                width="15"
                height="17"
                viewBox="0 0 20 22"
            ...
            />
            <div
              className={styles.carritoCompra}
